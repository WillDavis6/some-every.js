...
function hasAZero(num) {
    return num.toString().split('').some(function (z) {
        return z === '0';
    })
}

/*
Write a function called hasOnlyOddNumbers which accepts an array and returns true if 
every single number in the array is odd. If any of the values in the array are not odd,
...
and returns true if every single object in the array contains that key. Otherwise it
should return false.
...
function hasCertainValue(arr, key, searchValue) {
    return arr.every(function (obj) {
        // console.log(key in obj && searchValue in obj);
